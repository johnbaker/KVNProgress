		  ...
		  completion:(KVNCompletionBlock)completion
{
	...
	if ([self.class isVisible]) {
		...
		dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.1f * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
			if (![KVNBlockSelf.animateAppearanceOperation isFinished] && ![KVNBlockSelf.animateAppearanceOperation isExecuting] && ![[KVNBlockSelf.queue operations] containsObject:KVNBlockSelf.animateAppearanceOperation]) {
